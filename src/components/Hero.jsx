    ...
    <main className='md:px-4 px-4 max-w-screen-2xl mt-48  mx-auto '>
      <div className='flex md:flex-row gap-8 md:gap-0  flex-col-reverse justify-center items-center'>
        ...
        <div className='space-y-2   py-2'>
          ...
          <h3 className='text-slate-500 text-lg font-semibold dark:text-white'>Learning Frontend With React Js and Tailwind Css</h3>
          <p className='md:w-3/4 text-md text-gray-700 dark:text-white/80'>A 15 years old boy from Bangladesh . Try to code for his interest created by his brother Named Arian Zesan . A ui/ux Designer. They are on a mission . </p>
